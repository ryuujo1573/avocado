...
- Phase plans:
  - [Phase 0 — Foundations](./2026-04-19-mvp-phase-0-foundations.md)
  - [Phase 1 — Connectivity](./2026-04-19-mvp-phase-1-connectivity.md)
  - [Phase 2 — Signaling & WebRTC Transport](./2026-04-19-mvp-phase-2-signaling-transport.md)
  - [Phase 3 — Remote Shell](./2026-04-19-mvp-phase-3-remote-shell.md)
  - [Phase 4 — File Transfer](./2026-04-19-mvp-phase-4-file-transfer.md)
  - [Phase 5 — Hardening & Ship](./2026-04-19-mvp-phase-5-hardening.md)
...
- [ ] Phase 1 complete (connectivity)
- [ ] Phase 2 complete (signaling + WebRTC)
- [ ] Phase 3 complete (remote shell)
- [ ] Phase 4 complete (file transfer)
- [ ] Phase 5 complete (hardening + ship)
